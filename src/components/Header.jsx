const Header = () => {
  return (
    <div className="sticky top-0 z-10 bg-black bg-opacity-50 max-w-full h-[77px] mx-auto px-[35px] flex justify-between items-center">
      <img
        src="https://www.krafton.com/wp-content/themes/krafton/assets/img/logo/logo-white.png"
        alt="header logo"
        className="w-[110px]"
      />
      <div className="text-white justify-between hidden lg:flex flex-row gap-8 xl:gap-12 xl:text-xl 2xl:gap-20">
      ...
      <div className="w-[120px] justify-between hidden lg:flex lg:text-xs xl:text-xs 2xl:text-sm">
